...
<?php 
    ...
    if (isset($_GET['id'])){
        ...
        $query = "SELECT * from day2 where id = '$id'";
...
?>
    ...
    <?php
        ...
        if (isset($_POST['update_d2']))
        {
            ...
            $query = "UPDATE `day2` SET `title` = '$title', `date` = '$date', `subtitle` = '$subtitle', `storyone` = '$storyone', `storytwo` = '$storytwo' WHERE `id` = '$idnew'";
...
<form style="margin: 15%" action="updatetwo.php?id_new=<?php echo $id; ?>" method="post">
  ...
  <button type="submit"  class="btn btn-success" name="update_d2" style="margin: 20px">Update</button>
