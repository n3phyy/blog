	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Title Section</h1>
				    </div>
							    ...
							    <div class="table-responsive">
									...
									?>
											...
											<tr>
												...
												<td class="cell"> <?php echo $row['definition'];?></td>
								
												<td><a href="updates/updatemain.php?id=<?php echo $row['id']; ?>" class="btn btn-success"> Edit </a> </td>
											</tr>
											<?php
									}
								}
